...
class CondIndepPotTestCase(unittest.TestCase):
    def test_case1(self):
...
if __name__ == "__main__":
    ...
    suite.addTest(CondIndepPotTestCase("test_case1"))
    suite.addTest(CondIndepPotTestCase("test_case2"))
